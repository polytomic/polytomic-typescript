...
export class ErrorHandlingClient {
     ...
     *
     * @param {string} id - Unique identifier of the model sync.
    ...
    ): core.HttpResponsePromise<Polytomic.SyncErrorHandlingEnvelope> {
    ...
    private async __get(
        id: string,
        requestOptions?: ErrorHandlingClient.RequestOptions,
    ): Promise<core.WithRawResponse<Polytomic.SyncErrorHandlingEnvelope>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `api/syncs/${core.url.encodePathParam(id)}/error-handling`,
            ),
            method: "GET",
            headers: _headers,
        ...
        if (_response.ok) {
            return { data: _response.body as Polytomic.SyncErrorHandlingEnvelope, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {string} id - Unique identifier of the model sync.
     * @param {Polytomic.modelSync.UpdateSyncErrorHandlingRequest} request
