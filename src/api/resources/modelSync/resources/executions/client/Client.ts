...
export class Executions {
    ...
    public async list(
    ...
    ): Promise<Polytomic.V2ListExecutionResponseEnvelope> {
        ...
        if (_response.ok) {
            return _response.body as Polytomic.V2ListExecutionResponseEnvelope;
        }
    ...
    public async get(
        ...
        id: string,
        requestOptions?: Executions.RequestOptions
    ): Promise<Polytomic.V2GetExecutionResponseEnvelope> {
        const _response = await core.fetcher({
            url: urlJoin(
                (await core.Supplier.get(this._options.environment)) ?? environments.PolytomicEnvironment.Default,
        ...
        if (_response.ok) {
            return _response.body as Polytomic.V2GetExecutionResponseEnvelope;
        }
