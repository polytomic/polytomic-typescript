...
class Identity {
     ...
     */
    apiV2GetIdentity(requestOptions) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const _response = yield core.fetcher({
                url: (0, url_join_1.default)((_a = (yield core.Supplier.get(this._options.environment))) !== null && _a !== void 0 ? _a : environments.PolytomicApiEnvironment.Default, "api/me"),
                method: "GET",
                headers: {
            ...
            if (_response.ok) {
                return yield serializers.V2GetIdentityResponseEnvelope.parseOrThrow(_response.body, {
